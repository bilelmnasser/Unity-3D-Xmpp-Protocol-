...
using Xmpp.protocol.iq.auth;
using Xmpp.protocol.iq.agent;
using Xmpp.protocol.iq.disco;
using Xmpp.protocol.iq.roster;
using Xmpp.protocol.iq.register;
using Xmpp.protocol.iq.version;
...
using Xmpp.protocol.extensions.caps;
using Xmpp.protocol.extensions.compression;

using Xmpp.Exceptions;
...
namespace Xmpp
{
	...
	{       
        ...
        private     string                  m_ClientLanguage    = "fr";
        private     string                  m_ServerLanguage    = null;
		private		string					m_Username			= "";
		private		string					m_Password			= "";        
		private		string					m_Resource			= "colocarts";		
        ...
        /// </summary>
        /// <seealso cref="Xmpp.protocol.Base.XmppPacket.Language"/>
		...
		*/
		...
		public override void StreamParserOnStreamElement(object sender, Node e)
		{
            ...
            else if (e is Xmpp.protocol.Error)
            {
