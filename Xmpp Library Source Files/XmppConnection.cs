...
using Xmpp.Net;
using Xmpp.protocol.extensions.bosh;
...
namespace Xmpp
{
	...
	{	
		...
		public XmppConnection(Xmpp.Net.SocketConnectionType type) : this()
		{
			m_SocketConnectionType = Xmpp.Net.SocketConnectionType.Direct;
		}
		#endregion
		...
		private void InitSocket()
		{
			...
			// Socket Stuff
			if (m_SocketConnectionType == Xmpp.Net.SocketConnectionType.HttpPolling)
				m_ClientSocket= new PollClientSocket();            
            else if (m_SocketConnectionType == Xmpp.Net.SocketConnectionType.Bosh)
