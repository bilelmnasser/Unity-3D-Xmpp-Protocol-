...
using Xmpp.protocol.x.muc;
using Xmpp.protocol.x.muc.iq;
using Xmpp.protocol.x.muc.iq.admin;
using Xmpp.protocol.x.muc.iq.owner;
...
namespace Xmpp.protocol.x.muc
{
    ...
    public class MucManager
    {
        ...
        */
        ...
        {
            OwnerIq oIq = new Xmpp.protocol.x.muc.iq.owner.OwnerIq(IqType.set, room);
        ...
        {
            OwnerIq oIq = new Xmpp.protocol.x.muc.iq.owner.OwnerIq(IqType.get, room);          
        ...
        */
        ...
        public void RequestList(Affiliation affiliation, Jid room, IqCB cb, object cbArg)
        {
            ...
            aIq.Query.AddItem(new Xmpp.protocol.x.muc.iq.admin.Item(affiliation));
        ...
        public void RequestList(Role role, Jid room, IqCB cb, object cbArg)
        {
            ...
            aIq.Query.AddItem(new Xmpp.protocol.x.muc.iq.admin.Item(role));
        ...
        public void ModifyList(Jid room, Xmpp.protocol.x.muc.iq.admin.Item[] items)
        {
            ModifyList(room, items, null, null);
        }

        public void ModifyList(Jid room, Xmpp.protocol.x.muc.iq.admin.Item[] items, IqCB cb)
        {
            ModifyList(room, items, cb, null);
        }

        public void ModifyList(Jid room, Xmpp.protocol.x.muc.iq.admin.Item[] items, IqCB cb, object cbArg)
        {
            AdminIq aIq = new AdminIq();
            aIq.To = room;
            aIq.Type = IqType.set;

            foreach (Xmpp.protocol.x.muc.iq.admin.Item itm in items)
            {
        ...
        private void ChangeRole(Role role, Jid room, string nickname, string reason, IqCB cb, object cbArg)
        {
            ...
            Xmpp.protocol.x.muc.iq.admin.Item itm = new Xmpp.protocol.x.muc.iq.admin.Item();
            itm.Role = role;
